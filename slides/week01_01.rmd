---
title:  "Week01.01"
subtitle: "GEOG 4/5/7 9073: Environmental Analysis in R:"
...
-   A bit mis-named
-   My second time teaching it here at KSU - so we have space to experiment a bit
...
-   Imagine it’s May 2026 – what would make you feel like you were successful in this course. SAVE THIS SOMEWHERE!!!

## My introduction {.smaller}
...
-   Students are expected to attend all class meetings, but attendance is not graded. **Participation is graded, though**
...
-   Academic integrity
    ...
    -   Don’t plagiarize
-   Health and safety
    -   Student support services ([https://www.kent.edu/studentsupportservices)](https://www.kent.edu/studentsupportservices)){.uri}
...
## R and RStudio: Understanding the Relationship {.smaller}

R and RStudio are [**complementary but distinct tools**]{.underline} that work together for data analysis:
...
[***Always (mostly) work in scripts rather than only in the Console—this ensures reproducibility***]{.underline}

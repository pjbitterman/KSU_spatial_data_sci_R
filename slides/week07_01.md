...
- **This week** will cover "weeks 6 & 7" on Canvas
- **Next week** will catch-up by completing week 8 (point-pattern analysis)
- Then...
  - (wk9) Spring Break
  - (wk10) "Off" again for AAG (big geography conference)
  - (wk11) Will meet Tuesday (March 24th), off Thursday (March 26th)
...
library(tmap)
```
### And follow along with ```./src/week07_inclass.Rmd``` from the class repo
...
<img
  src="./images/de9im3.jpg"
  alt="an image describing the 9-intersection model"
  width="650"
/>
...
# A spatial join the "typical" way
...
- In Vermont, they're doing something a bit different
...
# If there's time,
## return to last week's Wild Card activity...

...
## Week 8.01: Localized spatial analysis
...
- Week 9: Spring break
- Week 10: AAG
- Week 11: Rasters and (Thursday) traveling
- Week 12: Time series
- Week 13: Making maps
- Week 14: Interactive mapping
...
- Thursday: 
    - (If necessary) finish lecture
    - Lab 3: builds on lecture and demonstrates how to calculate spatial autocorrelation in R
...
* This is often experienced and measured as *spatial autocorrelation*

---

## Spatial autocorrelation of areal units (% Bachelor's deg., 2020 ACS)

<img
  src="./images/oh_spatial_auto.png"
  alt="proportion of population with Bachelor's degree, Ohio counties"
  width="700"
/>
...
<img
  src="./images/autocorrelation.png"
  alt="spatial autocorrelation example"
/>
...
# Formalizing processes (two examples)
...
# Spatial weights matrices are a...
...
- Zone i and j are neighbors if zone i is contiguous with or adjacent to zone j
...
<img
  src="./images/contiguity_neighbors.png"
  alt="contiguity neighbors"
/>
...
<img
  src="./images/contiguity_nets.png"
  alt="continguity displayed as a network"
/>
...
<img
  src="./images/higher_order_contiguity.png"
  alt="higher order contiguity"
  width="850"
/>
...
<img
  src="./images/distance_nearest.png"
  alt="distance-based neighbors (threshold)"
/>
...
<img
  src="./images/simple_weights_matrix.png"
  alt="simple weights matrix"
/>
...
# Moran plot: variable (y) vs. lagged varaible (Wys)

<img
  src="./images/aribasbell_moranplot.png"
  alt="a simple Moran plot"
  width="500"
/>
...
<img
  src="./images/moran_plot.png"
  alt="moran plot with quadrant labels"
/>
...
<div>
<img src="./images/orlando_clusters.png"
     alt="Local Moran’s I cluster/outlier map for household income in Orlando showing high-high, low-low clusters and spatial outliers."
     width="570" />
</div>
...
- Thursday: Lab 3 starts
- Chapter 9 from your textbook
